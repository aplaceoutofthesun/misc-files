...
from platform import python_version as vers
from IPython import release
ipyvers = release.version 
banner = '\n' + ('-'*80)+'\n * '+ vers() +'\t\t\t\t\t\t\t\t'+ ipyvers+' * \n'+('-'*80)+'\n'
c.InteractiveShell.banner1 = banner
#c.InteractiveShell.banner1 = "Python 3.8.2 (tags/v3.8.2:7b3ab59, Feb 25 2020, 23:03:10) [MSC v.1916 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 7.13.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.TerminalInteractiveShell.highlighting_style = 'harlequin'
# c.TerminalInteractiveShell.highlighting_style = 'fruity'
# c.TerminalInteractiveShell.highlighting_style = 'monokai'
#c.TerminalInteractiveShell.highlighting_style = traitlets.Undefined
# Good Ones: fruity, monokai, trac?, native, vim?, paraiso-light?
#            paraiso-dark, lovelace?, arduino?, solarized-dark,
#            solarized-light, inkpot, harlequin
