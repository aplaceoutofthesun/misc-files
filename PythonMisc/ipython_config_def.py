...
#c.InteractiveShellApp.exec_lines = ['%alias cls clear']
...
#         highlighting: 
#  vim, abap, autumn, algol, pastie, lovelace, xcode, algol_nu, rainbow_dash, vs, borland, rrt, murphy, friendly, igor, colorful, bw, trac, fruity, manni, monokai, arduino, paraiso-light, emacs, paraiso-dark, perldoc, tango, default, native
